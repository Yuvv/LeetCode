/**
 * 1296-divide-array-in-sets-of-k-consecutive-numbers.java
 *
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // true
        System.out.println(s.isPossibleDivide(new int[]{1,2,3,6,2,3,4,7,8}, 3));
        // false
        System.out.println(s.isPossibleDivide(new int[]{1,2,3,4,5}, 4));
    }
}