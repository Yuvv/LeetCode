...
public class Solution {
    public int reachableNodes_tle(int[][] edges, int maxMoves, int n) {
    ...
    public void getReachableNodes(Map<Integer, Map<Integer, boolean[]>> graph, Set<Integer> traceNodes, LinkedHashSet<Integer> router, Integer fromNode, int maxMoves) {
